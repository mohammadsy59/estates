        ...
        items: List.generate(
            ...
            (index) => PropertyItem(
                home: Home(
                    ...
                    estDescription: populars![index].estDescription,
                    estFloor: populars[index].estFloor,
                    estImage: populars[index].estImage,
                    estLocation: populars[index].estLocation,
                    estPrice: populars[index].estPrice,
                    estRating: populars[index].estRating,
                    estRooms: populars[index].estRooms,
                    estStatus: populars[index].estStatus,
                    estType: populars[index].estType,
                    estTimestamp: populars[index].estTimestamp,
                    isFavorited: populars[index].isFavorited))));
  }
